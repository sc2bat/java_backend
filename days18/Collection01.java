...
// 1. 배열
// - 다수개의 요소를 저장할 수 있음, 번호(첨자)에 의해 손쉬운 접근 방법을 제고
...
// 자바의 모든 자료구조 클래스(컬렉션 클래스)들을 java.util 패키지를 통해 제공받을 수 있음
...
// Map 타입 : 데이터를 Key 와 Value 의 형태로 저장하는 방법
// (검색을 위해서 사용, Key 의 값은 중복을 허용하지 않음, Value 의 값은 중복을 허용)
// - Hashtable, HashMap(가장많이 사용)
...
//		a[0] = 10		a[1] = 20		a[2] = 100		
//		a[0] = 10		a[1] = 20		a[2] = 300		a[3] = 100		
