...
// 자식 클래스에서 사용하지 않을 추상 메소드라도, 객체 생성을 위해 반드시 구현해야하는 문제점이 있습니다
...
// AbstractA 클래스를 상속 받은 클래스는 필요없는 메소드가 있어도, 추상메소드를 모두 오버라이드(구현)해야합니다
...
// 모든 추상클래스가 구현(오버라이드)된 AbstractA_Adapter 클래스를 생성하고, 
// 이 클래스를 상속받아 사용하면 필요없는 메소드를 강제로 구현(오버라이드)하지 않고 필요한 것만
// 구현하여 사용할 수 있습니다
...
public class Extends10_Abstract03 {
	...
	public static void main(String[] argrs) {
		...
		obj.test1();
		//할아버지 손자간 다형성을 구현하여
		// 물려주고 오버라이딩된 메소드를 할아버지 레퍼런스가 사용할 수 있습니다
