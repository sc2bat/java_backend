...
//		9. Hellos.indexOf('e', 2)-> -1
		...
		s2 = s.replace("ll", "LL"); // ll을 LL 로 치환
		System.out.println("11. " + s + " " + s2);
		//String 클래스는 보관하고 잇는 문자열을 이용하여 변화를 주는 메소드들에서 변화된 내용이 업데이트 되듯 저장되는 것이 아니고
		// 대부분 새로운 변화된 문자열 객체로 만들어 리턴합니다. 다른 메소드와 마찬가지로 원본이 보호됩니다.
		// 따라서 다양한 메소드들이 있지만 실행결과가 원본 s문자열을 변경시키지는 못합니다
//		11. Hellos.replace('H', 'C')-> Cello
//		11. Hello Cello
//		11. Hello s.replace("ll", "LL")->HeLLo
//		11. Hello HeLLo
...
//		12. [0]dog [1] cat [2] bear 
		
		//13.
		s = "java.lang.Object";
		s2 = s.substring(5, 9);
		//원본에서 다섯번째글자(0부터 시작)부터 8번째(9-1)까지 추출
		System.out.println("\n\n13. " + s2);
...
//		13. Object
		...
		Date dd = new Date(); //import 하게되면 java.util.date
		s = String.valueOf(dd);
		System.out.println("14. " + s);
//		14. true
//		14. 100
//		14. 100.123
//		14. Tue Nov 09 10:55:01 KST 2021
