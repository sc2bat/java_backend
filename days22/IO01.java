...
public class IO01 {
	...
	public static void main(String[] argrs) throws IOException {
		...
		/*
		System.out.println("글자나 숫자 하나를 입력하세요 : ");
...
//			입력된 문자 : 9
		...
		// 따라서 num 변수에는 입력한 글자의 아스키코드 값이 저장됩니다
		// A - 65 0 - 48 a - 97
		
		// new Scanner(System.in) 그동안 사용해오던 Scanner 도 위의 
		// System.in 의 객체를 모체로 하고 있습니다
		// 입력의 시작은 System.in 객체가 됩니다
		
		// 입력 스트림의 동작 방식
		// 입력 스트림의 경우 데이터를 입력받을 버퍼를 검색하여 해당 버퍼에 내용이 존재하지 않는 경우
		// 버퍼에 데이터가 쌓일때까지 대기함(키보드 입력의 경우 사용자가 데이터를 입력하고 엔터키를 입력할때까지)
