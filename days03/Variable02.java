...
import java.util.Scanner; // Scanner import // hotkey ctrl shift 'o'
...
public class Variable02 {
	...
	public static void main(String[] args) {
		...
		// 화면 입력을 위해서는 위 코드가 화면입력 동작보다 위쪽에 반드시 쓰여져있어야함
		num1 = sc.nextInt();
		// 컴파일러가 sc.nextInt() 명령을 만나면 커서를 깜박이면서 사용자에게서
		// 입력이 있을때까지 무한정 대기합니다.
		// 화면으로부터 정수를 입력받아 num1 변수에 저장
