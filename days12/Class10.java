...
public class Class10 {
	...
	public static void main(String[] argrs) {
		...
		//객체마다 멤버변수의 초기값을 달리하여 시작할 수 있습니다
		Cclass c1 = new Cclass(20);
		Cclass c2 = new Cclass(30);
		// 객체가 만들어지면서 멤버변수가 채워진 것
		
		//3. 클래스 내부에 개매겹눗를 갖든 안갖든, 생성자가 꺼내어지고 정의가 되면 숨어있던
		// 디폴트 생성자는 꺼내어져서 정의된 생성자로 대체되고 없어집니다
		
		//4. 위 클래스의 경우 디폴트 생성자가 없어졌으므로 아래는 에러입니다
		Cclass c3 = new Cclass(); // 에러
		// The constructor Cclass() is undefined -> 5
